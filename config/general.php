...
$siteTitle = 'Sistem Monitoring Realisasi Anggaran'; /* will be displayed above the url-bar / in tab / on Google */
$siteName = 'SIM Realisasi Anggaran'; /* The biggest title on your homepage */
$siteDesc ='Sub Direktorat - Kementrian Dalam Negeri'; /* subtitle on your homepage */
$siteTitleHome = 'Home'; // will be displayed above the url-ba / in tab / in google when the home-page is open
$siteFooter = '© 2014 - Sub Direktorat - Kementrian Dalam Negeri';
